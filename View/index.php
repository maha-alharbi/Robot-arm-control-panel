...
<div class="card text-white bg-dark" id="cardstyle">
<div class="card-body">
<div class="container-fluid ">
    
        
            <div class="col-md-9" style="padding-bottom: 5%; text-align:center">
             <span id="topTitle">Robot Arm Control Panel</span>
            </div>
...
<div class="row justify-content-center" style="padding-top: 5%;">
    ...
    <div class="col-sm-2"> 
        <a href="../Controller/RobotArmController.php?action=on"> <button class="btn btn-success"  type="button" name="on" style="width:5em;">On</button> </a>
    </div>

    <div class="col-sm-2"> 
        <a href="../Controller/RobotArmController.php?action=off"> <button class="btn btn-danger"  type="button" name="off" style="width:5em;">Off</button> </a>
    </div>
</div>
</div>
